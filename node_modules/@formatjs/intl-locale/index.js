...
function applyUnicodeExtensionToTag(tag, options, relevantExtensionKeys) {
    ...
    for (var _b = 0, relevantExtensionKeys_1 = relevantExtensionKeys; _b < relevantExtensionKeys_1.length; _b++) {
        ...
        (0, ecma402_abstract_1.invariant)(key in options, key + " must be in options");
        var optionsValue = options[key];
        if (optionsValue !== undefined) {
            (0, ecma402_abstract_1.invariant)(typeof optionsValue === 'string', "Value for " + key + " must be a string");
            value = optionsValue;
            if (entry) {
                entry[1] = value;
            }
